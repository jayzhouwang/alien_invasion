...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        # Git rid of bullets that haave disappeared.
    ...
    def _check_bullet_alien_collisions(self):
        """Respond to the bulles-alien collisions."""
    ...
    def _create_fleet(self):
        ...
        # Create the full screen of aliens.
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        alien.x = alien_width * 1.75 + 2 * alien_width * alien_number
    ...
    def _update_aliens(self):
        ...
        Check if the fleet is at an edge,
          then update the position of all aliens in the fleets.
        """
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            # Git rid of any remaining aliens and bullets.
            self.aliens.empty()
            self.bullets.empty()
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat this the same as ig the ship got hit.
                self._ship_hit()
                break
